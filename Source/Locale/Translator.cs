...
namespace ClassicLightFX.Locale
{
    ...
    internal static class Translator
    {
        ...
        private static void LoadAll()
        {
            ...
            {
                Debug.LogWarning("[ClassicLightFX] Locale folder not found: " + localePath);
                return;
            }
            ...
            foreach (string file in Directory.GetFiles(localePath, "*.xml"))
            {
                ...
                {
                    Debug.LogWarning("[ClassicLightFX] Could not read locale file " + file + ": " + e.Message);
                }
            }

            var current = SelectLanguage(languages);
            if (current == null)
            {
                return;
            }
        ...
        private static LanguageFile SelectLanguage(List<LanguageFile> languages)
        {
            ...
            return languages.Find(l => l.UniqueName == selected)
