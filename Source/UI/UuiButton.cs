namespace ClassicLightFX.UI
{
    ...
    /// tray is optional: the mod keeps its own hotkey (F9) as fallback.
    /// </summary>
    internal static class UuiButton
    {
        ...
        internal static bool Register(string title, string tooltip, Texture2D icon, Action<bool> onToggle)
        {
            ...
            {
                Debug.LogWarning("[ClassicLightFX] Unified UI registration failed: " + e.Message);
                return false;
            }
        }
        ...
        internal static void Unregister()
        {
            ...
            {
                Debug.LogWarning("[ClassicLightFX] UUI unregister: " + e.Message);
            }
            finally
            {
                _button = null;
