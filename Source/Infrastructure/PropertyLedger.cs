...
namespace ClassicLightFX.Infrastructure
{
    ...
    internal static class PropertyLedger
    {
        ...
        internal static void Write(object target, string path, object value, string owner = "ClassicLightFX")
        {
        ...
        internal static void Release(object target, string path, string owner = "ClassicLightFX")
        {
            if (target == null) return;
        ...
        internal static void ReleaseAll(string owner = "ClassicLightFX")
        {
        ...
        internal static void Forget(string owner = "ClassicLightFX")
        {
            foreach (var target in new List<object>(Entries.Keys))
            {
